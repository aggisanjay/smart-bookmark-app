...
//         },
//         (payload) => {
//           console.log('New bookmark added:', payload.new)
...
//         },
//         (payload) => {
//           console.log('Bookmark deleted:', payload.old)
...
//         },
//         (payload) => {
//           console.log('Bookmark updated:', payload.new)
//           setBookmarks((current) =>
...
//               className="flex-shrink-0 px-4 py-2 text-sm font-medium border border-white/10 rounded-lg hover:border-red-500/50 hover:bg-red-500/10 hover:text-red-400 transition-all opacity-0 group-hover:opacity-100 disabled:opacity-50 disabled:cursor-not-allowed"
